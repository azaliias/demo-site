...
/* @var $model app\models\search\RedirectSearch */
...
<div class="redirect-search">
    ...
    <?= $form->field($model, 'from')->textInput(['placeholder' => Yii::t('app', 'Redirect from')]); ?>

    <?= $form->field($model, 'to')->textInput(['placeholder' => Yii::t('app', 'Redirect to')]) ?>
